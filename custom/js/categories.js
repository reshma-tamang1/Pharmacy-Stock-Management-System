...
$(document).ready(function() {
	...
	$('#addCategoriesModalBtn').unbind('click').bind('click', function() {
		...
		$("#submitCategoriesForm").unbind('submit').bind('submit', function() {
			...
			if(categoriesName == "") {
				$("#categoriesName").after('<p class="text-danger">company Name field is required</p>');
			...
			if(categoriesStatus == "") {
				$("#categoriesStatus").after('<p class="text-danger">company Name field is required</p>');
		...
		$.ajax({
			...
			success:function(response) {
				...
				$("#editCategoriesForm").unbind('submit').bind('submit', function() {
					...
					if(categoriesStatus == "") {
						$("#editCategoriesStatus").after('<p class="text-danger">company Name field is required</p>');
