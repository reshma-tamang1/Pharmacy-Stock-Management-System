		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" data-target="#addcompanyModel"> <i class="glyphicon glyphicon-plus-sign"></i> Add company </button>
				</div> <!-- /div-action -->				
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitcompanyForm" action="php_action/createcompany.php" method="POST">
	      ...
	      <div class="modal-body">
	        ...
	        <div class="form-group">
	        	<label for="companyStatus" class="col-sm-3 control-label">Status: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="submit" class="btn btn-primary" id="createcompanyBtn" data-loading-text="Loading..." autocomplete="off">Save Changes</button>
	      </div>
	      <!-- /modal-footer -->
     	</form>
	     <!-- /.form -->
    	...
    	<form class="form-horizontal" id="editcompanyForm" action="php_action/editcompany.php" method="POST">
	      ...
	      <div class="modal-body">
		      ...
		      <div class="edit-company-result">
		        ...
		        <div class="form-group">
		        	<label for="editcompanyStatus" class="col-sm-3 control-label">Status: </label>
		        	<label class="col-sm-1 control-label">: </label>
					    <div class="col-sm-8">
	      ...
	      <div class="modal-footer editcompanyFooter">
	        ...
	        <button type="submit" class="btn btn-success" id="editcompanyBtn" data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> Save Changes</button>
	      </div>
	      <!-- /modal-footer -->
     	</form>
	     <!-- /.form -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer removecompanyFooter">
        <button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> Close</button>
        <button type="button" class="btn btn-primary" id="removecompanyBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> Save changes</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
